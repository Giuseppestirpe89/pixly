<?php $QRtoken =  '4b12b387e61ed6a88dcb9a404';?>
<?php
                            ...
                            <?php
                                ...
                                while ($row = mysql_fetch_assoc($result)) { 
                                   if (strpos($url, 'reportimage') !== false) {
                                        ...
                                        <div class='fb-like' data-href='https://developers.facebook.com/docs/plugins/pixlyireland' data-layout='button_count'data-action='like' data-size='small' data-show-faces='true' data-share='false'></div> &emsp;
