...
<div tabindex="-1" class="modal fade" id="myModal2" role="dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
            ...
            data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>&emsp; 
            <a class="twitter-follow-button"href="https://twitter.com/Pixly" data-size="small">Follow us</a> &emsp; Close </button>
	</div>
   </div>
  </div>
</div>
